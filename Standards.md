...
#### 27. Do not leave withe spaces :

```csharp 
// Avoid
public static bool doSomthing(string value) {
    if(expression)
...
#### 28. Do not leave your committed codes :
...
***Why: consistent with the Microsoft's .NET Framework and easy to read. You can go back to your code from source code handler***


#### 29. Do summary for each public function that will be reached from out site :
